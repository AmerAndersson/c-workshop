...
of the code by replacement. This replacement can be an expression, a statement,
a block or simply anything. The preprocessor does not understand C++ proper,
...
by the replacement expression, but also replacing each argument by its identifier,
