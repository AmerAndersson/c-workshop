...
int main(int argc, char const *argv[]) {
    ...
    // This code compiles, although it does not make much sense, since now b points to an object
    // of a totally unrelated and likely incompatible class. Dereferencing b is unsafe.
